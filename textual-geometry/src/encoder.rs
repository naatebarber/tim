...
use crate::geometry::{Geometry, Point, LossyPoint};
use hex;
...
impl<'a> Encoder<'a> {
    pub fn from_sequence(dim: u32, pad: u32, input_sequence: String, geometry: &'a mut dyn Geometry<Point>) -> Self {
...
impl<'a> LossyEncoder<'a> {
    pub fn from_sequence(dim: u32, pad: u32, input_sequence: String, geometry: &'a mut dyn Geometry<LossyPoint>) -> Self {
        let hex_repr = hex::encode(input_sequence);
